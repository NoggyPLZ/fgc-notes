  ...
  return (
    <div className="dark:bg-gray-900 bg-gray-300 pt-2 md:flex md:gap-1 pb-2 md:pb-0 grid grid-cols-2 gap-2">
      ...
      <div
        popover="auto"
        id="opponentsPopup"
        className="relative inset-y-0 mx-auto my-auto transform overflow-x-scroll rounded-lg bg-white px-4 pt-5 pb-4 text-left opacity-0 shadow-lg/50 transition-all [transition-behavior:allow-discrete] duration-500 sm:w-full sm:max-w-[600px] sm:p-6 w-[90%] max-h-[90%] dark:bg-gray-900 dark:border-1 dark:border-gray-950 [&:is([open],:popover-open)]:opacity-100 [@starting-style]:[&:is([open],:popover-open)]:opacity-0"
        ref={popRef}
      >
        <NoteTabOpponent
