...
export default async function SideNav() {
  ...
  return (
    <div className="flex flex-col h-full px-2 pt-2">
      <div className="bg-gray-200 dark:bg-gray-800 flex flex-col grow">
        ...
        <div className="flex grow flex-row md:flex-col justify-between">
          ...
          >
            <button className="px-3 py-5 md:p-5 grow h-auto md:py-5 w-full hover:bg-rose-500 md:bg-rose-500 text-gray-800 dark:text-gray-100 md:text-gray-100 cursor-pointer flex flex-col items-center md:flex-row justify-center gap-3 md:hover:bg-rose-700 hover:text-gray-100 border-gray-300 md:border-0 border-t-1 dark:border-gray-950 font-semibold">
              <Power strokeWidth={3} />
              Sign Out
            </button>
          </form>
